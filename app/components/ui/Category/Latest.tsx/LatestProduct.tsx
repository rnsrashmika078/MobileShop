...
const LatestProduct = ({ paginatedProducts, setIsInView, length }: Props) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center mt-16 text-center">
            ...
            <p className="text-gray-500 text-lg max-w-xl">
                Check out the newest arrivals in our store – fresh picks just
                for you!
            </p>
            <div
                className={`${
            ...
            >
                {paginatedProducts && paginatedProducts.length > 0 ? (
                    [...paginatedProducts, ...paginatedProducts].map(
                        (product, index) => (
                            <Card
                                onClickCapture={() =>
