    ...
    const options = [
        ...
        },
        {
            ...
            icon: (
                <MdOutlineLightMode
                    size={iconSize}
                    color={selectedOption === "Night Light" ? "black" : "white"}
                    className={`${
                        selectedOption === "Night Light"
                            ? "transition-all scale-120"
                            : "scale-100"
                    }`}
                />
        ...
        <div className="select-none">
            ...
            <div className="fixed bottom-2 right-2 w-100">
                <div className="border bg-[#323232]  border-gray-800/80 rounded-t-xl">
                    {open === "Wifi" && (
                        <div className="relative rounded-xl h-[350px] overflow-auto">
                        ...
                        <div>
                            <div className="relative  p-5 h-[250px] grid grid-cols-3 gap-5">
                                {options.map((opt, index) => (
                                    ...
                                    >
                                        <div
                                            className={`flex justify-between  border h-13 rounded-sm border-white/10 shadow-sm  ${
                                        ...
                                        >
                                            ...
                                            {opt.name === "Wifi" ||
                                                (opt.name === "Bluetooth" && (
                                                    <div className="border flex justify-center items-center border-white/10"></div>
                                                ))}
                                            <div
                                                className={`${
                                                    selectedOption === opt.name
    ...
    return (
        <div className="flex w-full z-100">
            ...
            >
                ...
                <div
                    className="absolute top-3.5  -translate-y-1/2 left-1/2 w-5.5 h-5.5 bg-gray-600 rounded-full transition-transform"
                    style={{
                        left: `${position}%`,
                        transform: "translate(-50%, -50%)",
                    }}
                >
                    <div className="absolute p-1 transition-all bg-[#61d7f1] backdrop-blur-xs  hover:p-2 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3"></div>
                    {dragging && (
                        <div
...
const WifiList = ({
    ...
    return (
        <div>
            <div className="p-2 scrollbar-hidden flex justify-between items-center text-white sticky top-0 bg-[#323232] z-100">
                <div
...
const ToggleButton = ({ toggle, setToggle }: ToggleProps) => {
    ...
    const trans = `translate-x-${transition}`;
    return (
        <div
...
const CheckBox = () => {
    ...
    return (
        <div
            className={`z-[-1] relative h-3 w-3 p-3 border  ${
                check
